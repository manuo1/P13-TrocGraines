...
USERNAME_CHANGE_UNIQ_ERROR_MSG = 'Ce nom d\'utilisateur est déja utilisé'

EMAIL_CHANGE_CONFIRM_MSG = 'Votre email a été modifié'

EMAIL_CHANGE_UNIQ_ERROR_MSG = 'Cet email est déja utilisé'
